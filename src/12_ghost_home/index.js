...
const bushMeterial = new THREE.MeshStandardMaterial({ color: '#89c845' })
...
bush4.position.set(-0.9, 0.2, 2.3)
home.add(bush1, bush2, bush3, bush4)
...
const tick = () => {
  ...
  // Updata Gohosts
  const ghostsAngle=elapsedTime *0.5
  ghosts1.position.x=Math.cos(ghostsAngle)*4
  ghosts1.position.z=Math.sin(ghostsAngle)*4
  ghosts1.position.y=Math.sin(ghostsAngle*3)

  const ghosts2Angle=elapsedTime *0.32
  ghosts2.position.x=Math.cos(ghosts2Angle)*5
  ghosts2.position.z=Math.sin(ghosts2Angle)*5
  ghosts2.position.y=Math.sin(ghostsAngle*4)+Math.sin(elapsedTime*2.5)
  ...
  ghosts3.position.y=Math.sin(ghosts3Angle*4)+Math.sin(elapsedTime*2.5)
